...
const DEFAULT_DEFINES: &'static [CDefine] = &[
    ...
    ("MBEDTLS_SSL_TLS_ATTESTATION",                       Defined),
    ("MBEDTLS_SSL_ATTESTATION_NONCE_LEN_MAX",             DefinedAs("32")), // default: 32
    ("MBEDTLS_PARSEC_ATTESTATION",                        Defined),
    ...
    ("MBEDTLS_USE_PSA_CRYPTO",                            Defined),
    ...
    ("MBEDTLS_PSA_CRYPTO_SE_C",                           Defined),
